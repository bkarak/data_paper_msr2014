...
{\it Delft University of Technology}\\
...
For our research we used {\it FindBugs},\endnote{\url{http://findbugs.sourceforge.net/}}
...
{\it Maven Central Repository}\endnote{\url{http://mvnrepository.com/}}
(approximately 265{\sc gb} of data---see Section~\ref{sec:data}).
...
list,\endnote{\url{http://www.mozilla.org/projects/security/known-vulnerabilities.html}}
...
Also, as bug descriptions indicate,\endnote{\url{http://findbugs.sourceforge.net/bugDescriptions.html}}
...
Table~\ref{tbl:severe} presents the number
...
security providers.\endnote{\url{http://cwe.mitre.org/top25/index.html}}
...
the domino effect.
%No matter how well a programmer secures a software component
...
We analysed more than 260{\sc gb} of interdependent project versions to see
...
of bytecode.\endnote{Our data and code are available online at:
...
artifacts with similar characteristics facilitates the formation of
