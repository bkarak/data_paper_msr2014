...
several additional information regarding the jar file that has been processed (Table~\ref{tbl:metadata-description}). The following listing contains a sample document:
