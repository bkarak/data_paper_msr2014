...
its size, its dependencies, and a number that represented the ordinal version number
...
Mongo{\sc db} database. FindBugs though,
...
In addition, to the FindBugs data, we also added a metadata
...
simple scripts to find out basic information like
